...
void app_main(void)
{
    ...
    wifi_connect_status_t wifi_connect_status = wifi_connect(WIFI_SSID, WIFI_PASS);
    if (wifi_connect_status == CONNECTED)
    {
        ESP_LOGI(MAIN_TAG, "Done.");
    }
    else
    {
        /* TODO: Error indicator LED */
        ESP_LOGE(MAIN_TAG, "Failed to connect to Wi-Fi!");
    }
